...
data1 = np.load('E:\GWNET_daima\Ameiguo2015_40_200\gwnet\gwnet_result\meiguo2015_gwnet_hangbanshu_predicts200.npy')
print(data1)
print(data1.shape)
...
print("#################################################################################")
####################################################################################
data2 = np.load('E:\GWNET_daima\Ameiguo2015_40_200\gwnet\gwnet_result\meiguo2015_gwnet_testy200.npy')
print(data2)
print(data2.shape)
...
y_sample = y_true[:, 6, 0]          #即显示的第2列列机场的真实值，可更改
y_pred_sample = y_preds[:, 6, 0]
