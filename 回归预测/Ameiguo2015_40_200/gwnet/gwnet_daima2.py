...
def main():
    ...
    adj_mx = util6.zhengzhou_load_adj("E:\GWNET_daima\Ameiguo2015_40_200\meiguo_data\meiguo2015_juli40.csv")
    ...
    for iter, (x, y) in enumerate(ex_dataloader['ex_loader'].get_iterator()):
        ...
        with torch.no_grad():
            ...
            np.save(file="E:\GWNET_daima\Ameiguo2015_40_200\gwnet\gwnet_result/meiguo2015_gwnet_juli_predicts200.npy", arr=baocun_predicts)
