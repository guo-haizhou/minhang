...
df = pd.read_csv('E:\meiguo2015\将数据集处理成邻接矩阵和特征矩阵\距离相关性矩阵\meiguo2015_juli40.csv')
print(df)
...
plt.savefig("D:\Desktop\研作业\大/距离邻接矩阵热图.svg", dpi=3000, format="svg", bbox_inches='tight', pad_inches=0)
plt.show()