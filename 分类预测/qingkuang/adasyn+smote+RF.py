...
df = df[[
         ...
         # # 'SCHEDULED_ARRIVAL', 'ARRIVAL_TIME','AIR_TIME','DISTANCE',
         'MONTH','DAY','DAY_OF_WEEK','FLIGHT_NUMBER','SCHEDULED_DEPARTURE','airline_code','ARRIVAL_TIME','air_time','chufa_code',
         'distance',
...
clf2 = RandomForestClassifier(n_estimators= 200,max_depth=10, min_samples_split=20,
